...
public class ProductServiceImpl implements ProductService {
	...
	public ProductServiceImpl(ProductRepository  productRepository,UserServiceImpl userServiceImpl,CategoryRepository categoryRepository) {
...
Category thirdLevel = categoryRepository.findByNameAndParent(req.getThirldLevelCategory(), secondLevel.getName());
		
		if(thirdLevel ==null) {
			Category thirdLevelCategory= new Category();
			thirdLevelCategory.setName(req.getThirldLevelCategory());
